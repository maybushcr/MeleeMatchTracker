...
public class CharacterWinRateByCharacter {

    private Integer characterId;
    private Integer opponentCharacterId;
    private Double winPercentage;

    public CharacterWinRateByCharacter(){}

    public CharacterWinRateByCharacter(Integer characterId, Integer opponentCharacterId, Double winPercentage) {
    ...
    public boolean equals(Object o) {
        ...
        CharacterWinRateByCharacter that = (CharacterWinRateByCharacter) o;
